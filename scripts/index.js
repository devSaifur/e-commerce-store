...
thumbnails.forEach(thumbnail => {
    ...
    thumbnail.addEventListener("click", (e) => {
        ...
        const remainingThumb = thumbnailArray.filter(element => element !== clickedElement)
...
addCartBtn.addEventListener("click", (e) => {
    const perProductPrice = 125.00
    price.innerText = `$125.00 x ${numberOfItems.innerText}`
    totalPrice.innerText = "$" + numberOfItems.innerText * perProductPrice + ".00"
